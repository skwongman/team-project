const model1 = {
    constructor: function(){
        ...
        const weatherDataTempPromise = getWeatherData("https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=CWB-DF2CB80E-CB70-453A-B35E-80356742388A");
        const weatherDataRainfallPromise = getWeatherData("https://opendata.cwa.gov.tw/api/v1/rest/datastore/O-A0002-001?Authorization=CWB-DF2CB80E-CB70-453A-B35E-80356742388A");
